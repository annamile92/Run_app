...
export default function Home() {
  const initialPlaylist = [
    ...
    },
    {
      ...
      title: "Runner - Maria (120 bpm)",
      bpm: 120,
      cadence: 152,
    },
    {
      id: 4,
      url: "/radio-tracks/coldplay_style_pad.wav",
      title: "Runner - Jose (120 bpm)",
      bpm: 120,
      cadence: 152,
    },
    {
      id: 5,
      url: "/radio-tracks/chaotic_sprint_172.wav",
      title: "Runner - Andrea (172 bpm)",
      bpm: 172,
      cadence: 152,
    },
  ];
    ...
    <main className="font-sans text-white">
      ...
      {menuOpen && (
        <div className="absolute top-20 left-4 w-48 bg-gradient-to-r from-purple-600 to-blue-500 rounded-xl flex flex-col items-start p-4 gap-3 md:hidden z-50">
          ...
          <Link href="/tienda" onClick={() => setMenuOpen(false)}>Shop</Link>
        </div>
      )}
      ...
      >
        ...
        <div className="md:w-1/2 flex flex-col gap-4">
          ...
          <p className="opacity-80">
            Explora la experiencia Run4Fun App.
          </p>

          <Image src="/qr-code.png" alt="QR App" width={180} height={180} />

          <a
            href="https://object-volt-59393284.figma.site/"
            target="_blank"
            rel="noopener noreferrer"
            className="mt-4 inline-block bg-gradient-to-r from-purple-600 to-blue-500 text-black font-semibold px-4 py-2 rounded-xl shadow-lg hover:scale-105 transition-all"
          >
            Abrir la App
          </a>
        </div>
